...
w1=0.02; % percentage of time you approve of a candidate outside your own party
w2=0.8;  % percentage of time you approve of a candidate within your own party
...
s=0.5+0.5*sign(rand(n,p)-(1-w1)); % initialze random (0 or 1) votes, with highest probabilty of
                                  % approval (as tweaked below) for candidates within one's party,
s(1         :n1,         1 :10)=0.5+0.5*sign(rand(n1,10)-(1-w2)); % Party A 
s(n1+1      :n1+n2,      11:20)=0.5+0.5*sign(rand(n2,10)-(1-w2)); % Party B 
s(n1+n2+1   :n1+n2+n3,   21:30)=0.5+0.5*sign(rand(n3,10)-(1-w2)); % Party C 
s(n1+n2+n3+1:n1+n2+n3+n4,31:40)=0.5+0.5*sign(rand(n4,10)-(1-w2)); % Party D 
